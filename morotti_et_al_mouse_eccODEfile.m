...
fracPKA_Myoo = 0.062698; % as Troponin I
fracPKA_Myoiso = 0.868762; % as Troponin I after 120 s w/ ISO
...
while (abs(corL)>.00001)
   ...
   FB=Ap*(y(85+4)+y(87+4))*(L-y(88+4))+Aw*y(86+4)*(L-y(89+4)); 
   w=FB+Ke*(L-Lz)^5+Le*(L-Lz)-Fm;
   w1=Ap*(y(85+4)+y(87+4))+Aw*y(86+4)+5*Ke*(L-Lz)^4+Le+bet*(Fm+alfa);
   corL=-w/w1;
   L=L+.1*corL; 
   con=con+1;
   if con>200,
...
TS=TSt-y(84+4)-y(85+4)-y(86+4)-y(87+4);
ER=exp(-RLa*(L-La)^2); 
Yh=Yv*(1-exp(-gama*(L-y(89+4)-hwr)^2));
if (L-y(89+4))>hwr;
    Yh=Fh*Yh;
end
fa=f*ER;
ga=Za+Yh;
gd=Yd*exp(-Yc*(L-Lc)); 
ydot(84+4)=ga*y(86+4)-fa*y(84+4)+Yb*TS*y(38)^nc-Zb*y(84+4);%----------TSCa
ydot(85+4)=Zr*y(87+4)*y(38)^nc-Yr*y(85+4)+Yp*y(86+4)-Zp*y(85+4);%-------TSCa*
ydot(86+4)=Zp*y(85+4)-Yp*y(86+4)+fa*y(84+4)-ga*y(86+4);%----------------TSCa#
ydot(87+4)=-gd*y(87+4)+Yr*y(85+4)-Zr*y(87+4)*y(38)^nc;%---------------TS*
ydot(88+4)=Bp*(L-y(88+4)-hpr);%----------------XB-power
ydot(89+4)=Bw*(L-y(89+4)-hwr);%----------------XB-weak
if(mechFlag==1),
...
ydot(19) = nc*(ydot(84+4)+ydot(85+4)+ydot(86+4)); % myofilament
