...
y_ecc = y(1:87+6);  % Ca_j is y(36), Ca_sl is y(37), Ca_cytosol is y(38)
y_camDyad = y(87+6+1:87+6+15);
y_camSL = y(87+6+15+1:87+6+15+15);
y_camCyt = y(87+6+30+1:87+6+30+15);
y_CaMKII = y(87+6+45+1:87+6+45+6);      % 6 state vars in CaMKII module
y_BAR = y(87+6+45+6+1:87+6+45+6+36);    % 30+2+4 state vars in BAR module
...
CaMKIIact_Dyad = CaMKIItotDyad.*(y(87+6+8)+y(87+6+9)+y(87+6+10)+y(87+6+11)); % Multiply total by fraction
CaMKIIact_SL = CaMKIItotSL.*(y(87+6+15+8)+y(87+6+15+9)+y(87+6+15+10)+y(87+6+15+11));
    %PP1_PLB_avail = y(87+45+6+22)./PP1_PLBtot + .0091;  % Active PP1 near PLB / total PP1 conc + basal value
    PP1_PLB_avail = 1 - y(87+6+45+6+24)/PP1_PLBtot + 0.081698; % NEW ODEs
...
LCC_CKdyadp = y(87+6+45+2)./LCCtotDyad;   % fractional CaMKII-dependent LCC dyad phosphorylation
RyR_CKp = y(87+6+45+4)./RyRtot;           % fractional CaMKII-dependent RyR phosphorylation
PLB_CKp = y(87+6+45+5)./PLBtot;           % fractional CaMKII-dependent PLB phosphorylation
...
LCCa_PKAp = y(87+6+45+6+28)./LCCtotBA;
LCCb_PKAp = y(87+6+45+6+29)./LCCtotBA;
PLB_PKAn = (PLBtotBA - y(87+6+45+6+26))./PLBtotBA;
RyR_PKAp = y(87+6+45+6+30)./RyRtotBA;
TnI_PKAp = y(87+6+45+6+31)./TnItotBA;
IKs_PKAp = y(87+6+45+6+34)./IKstotBA;
ICFTR_PKAp = y(87+6+45+6+35)./ICFTRtotBA;
IKur_PKAp = y(87+6+45+6+36)./IKurtotBA;
%PLM_PKAn = (PLMtotBA - y(87+45+6+32))./PLMtotBA;
PLM_PKAp = y(87+6+45+6+27)./PLMtotBA;
